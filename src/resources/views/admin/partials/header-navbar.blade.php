      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu">
          ...
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <span class="hidden-xs">{{$user->name != null ? $user->name : ""}}</span>
          </a>
          <ul class="dropdown-menu">
            ...
            <li class="user-header">
              ...
              <p>
                {{$user->name != null ? $user->name : "Alexander Pierce"}}<br/>
                {{$user->profile != null ? $user->profile->experience : "Web Master"}}
                <small>Member since {{$user != null ? $user->created_at->diffForHumans() : "Nov. 2012"}}</small>
              </p>
            </li>
            <!-- Menu Body -->
            <li class="user-body">
            ...
            <li class="user-footer">
              <div class="pull-left">
                <a href="{{url('admin/profile', $user->id)}}" class="btn btn-default btn-flat">Profile</a>
              </div>
